            ...
            <Card className="border-dashed border-slate-700">
                ...
                <div className="p-6 pt-0">
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors bg-blue-600 text-white hover:bg-blue-700 h-10 px-4 py-2 w-full"
                    >
