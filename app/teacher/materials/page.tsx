...
export default function MaterialsPage() {
    ...
    return (
        <div className="p-8 space-y-8 animate-fade-in">
            ...
            {/* Upload New Material Card - Full Width */}
            <Card className="border-dashed">
                <div className="flex flex-col space-y-1.5 p-6">
                    <Title title="Upload New Material" text="2xl" />
                    <Subtitle title="Add new study materials for your students" />
                </div>
                <div className="p-6 pt-0">
                    <button
                        onClick={handleUpload}
                        className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors bg-pumpkin text-white hover:bg-pumpkin/90 h-10 px-4 py-2 w-full"
                    >
